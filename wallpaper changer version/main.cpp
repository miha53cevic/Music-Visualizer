...
protected:
	...
	{
		renTex.create(ScreenWidth(), ScreenHeight());
	...
	bool virtual OnUserUpdate(sf::Time elapsed)
	{
		...
		// Save it as a .png
		renTex.getTexture().copyToImage().saveToFile("screenshot.png");

		// Set wallpaper
		const wchar_t *filenm = L"D:/VS Studio Projects/SFML_CPP Projects/FFTW Visualizer/Release/screenshot.png";
